...
export default function MediaCard({ media, showMediaType = false }: MediaCardProps) {
  ...
  const mediaTypeLabel = mediaType === 'movie' ? 'Movie' : mediaType === 'tv' ? 'TV Show' : 'Person';
  const ratingText = media.vote_average && media.vote_average > 0 
            ...
            {posterUrl ? (
              ...
              >
                <div className="text-center p-3 md:p-4">
                  <div className="text-3xl md:text-4xl mb-2" aria-hidden="true">🎬</div>
