...
import { createClient, getUserCustomLists, addItemToList, checkItemInList, type CustomListWithItems } from "@/lib/supabase/client"
...
export function AddToListButton({
  ...
  const loadLists = async () => {
    try {
      ...
      const alreadyInLists = listsWithStatus
