    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-4">
        <div className="flex items-center gap-2">
          ...
          <Select
            value={sortBy}
            onValueChange={(value: 'added_date' | 'priority') => setSortBy(value)}
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <Select
            value={filterBy}
            onValueChange={(value: 'all' | 'movie' | 'tv') => setFilterBy(value)}
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <Select
            ...
            onValueChange={(value: 'all' | '0' | '1' | '2' | '3') => setPriorityFilter(value)}
          >
            <SelectTrigger className="w-32">
              <SelectValue />
            </SelectTrigger>
                  ...
                  <div className="flex-shrink-0">
                    {posterUrl ? (
                      <div className="aspect-[2/3] w-20 relative">
                        <Image src={posterUrl} alt={title} fill className="object-cover rounded" />
                      </div>
                    ) : (
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          ...
                          {item.priority !== undefined && item.priority > 0 && (
                            <Badge
                              className={
                                priorityLabels[item.priority as keyof typeof priorityLabels].color
                              }
                            >
                              {priorityLabels[item.priority as keyof typeof priorityLabels].label}{' '}
                              Priority
                            </Badge>
                          )}
